  ...
  return (
    <BuildLayout org={org} project={project}>
      <div style={{ maxWidth:'720px' }}>
        ...
        <p style={{ fontSize:'14px', color:'rgba(237,240,247,0.5)', lineHeight:1.65, marginBottom:'32px' }}>Tax obligations per jurisdiction. Amounts owed, filing deadlines, and step-by-step guidance on how to pay.</p>
