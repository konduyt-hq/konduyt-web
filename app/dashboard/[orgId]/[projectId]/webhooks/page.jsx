  ...
  return (
    <BuildLayout org={org} project={project}>
      <div style={{ maxWidth:'720px' }}>
        <h1 style={{ fontFamily:"'Space Grotesk',sans-serif", fontWeight:700, fontSize:'22px', color:'#EDF0F7', marginBottom:'8px' }}>Webhooks</h1>
        <p style={{ fontSize:'14px', color:'rgba(237,240,247,0.5)', lineHeight:1.65, marginBottom:'32px' }}>Event logs, retry history, and endpoint configuration. Every payment event is logged here.</p>
