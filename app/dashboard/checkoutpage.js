...
<body>
  ...
  <script>
    var LOCAL_METHODS = {"AD": ["Cards (SEPA/interchange-regulated)"], "AE": ["Cards"], "AF": ["HesabPay"], "AG": ["Bank Transfer", "Cards", "Online Banking"], "AR": ["American Express", "Cuenta DNI", "MODO", "Mastercard", "Mercado Pago", "Pago Fácil", "Rapipago", "Transferencias 3.0", "Visa"], "AT": ["EPS"], "AU": ["Apple Pay/Google Pay", "BECS Direct Debit", "BPAY", "NPP", "Osko", "PayID", "Visa/Mastercard", "Cards", "eftpos"], "BB": ["Bank Transfer", "Cards", "Online Banking", "SurePay", "WiPay"], "BE": ["Bancontact"], "BG": ["BORICA", "ePay.bg"], "BH": ["Cards"], "BI": ["Burundi"], "BO": ["Bank Transfers", "Cards", "QR Simple", "Tigo Money", "Yape Bolivia"], "BR": ["Boleto Bancário", "Elo", "Hipercard", "Mastercard", "Mercado Pago", "PagBank", "PicPay", "Pix", "Pix Automático", "Pix Cobrança", "TED", "Visa"], "BS": ["Bank Transfer", "Cards", "Online Banking", "Sand Dollar"], "BZ": ["Bank Transfer", "Cards", "Online/Mobile Banking"], "CA": ["Apple Pay/Google Pay", "Interac Debit", "Interac Online", "Interac e-Transfer", "Visa/Mastercard"], "CH": ["TWINT"], "CI": ["Cards"], "CL": ["Bank Transfer", "Khipu", "MACH", "Mastercard", "Mercado Pago", "Onepay", "Redcompra", "Visa", "Webpay"], "CO": ["Bank Transfer", "Daviplata", "Efecty", "Mastercard", "Mercado Pago", "Nequi", "PSE", "Transfiya", "Visa"], "CR": ["Cards", "SINPE Móvil", "SINPE Transfers"], "CU": ["Bank Cards", "EnZona", "Transfermóvil"], "CV": ["Cards"], "DE": ["Wero"], "DJ": ["Djibouti"], "DK": ["MobilePay"], "DM": ["Bank Transfer", "Cards", "D-Money", "Online Banking"], "DO": ["Bank Mobile Apps", "Bank Transfer", "Cards", "Pago Móvil", "tPago"], "DZ": ["Cards (CIB/EDAHABIA)", "Cards"], "EC": ["Bank Transfer", "Deuna", "Mastercard", "PayPhone", "Visa"], "EG": ["Cards"], "ES": ["Bizum"], "FI": ["MobilePay"], "FJ": ["Bank Transfer", "Cards", "EFTPOS", "M-PAiSA", "MyCash"], "FM": ["Bank Transfer", "Cards", "Mobile/Internet Banking"], "FR": ["Cartes Bancaires / Wero"], "GB": ["Pay by Bank (Open Banking)", "Cards"], "GD": ["Bank Transfer", "Cards", "Online Banking"], "GH": ["Cards"], "GN": ["Guinea"], "GQ": ["Equatorial Guinea"], "GR": ["IRIS"], "GT": ["Bank Transfer", "Cards", "Mobile Banking"], "GW": ["Guinea-Bissau"], "GY": ["Bank Transfer", "Cards", "GTT Mobile Money", "MMG Mobile Money"], "HN": ["Bank Transfer", "Cards", "Mobile Banking", "Tengo", "Tigo Money"], "HR": ["Aircash"], "HT": ["Bank Transfer", "Cards", "MonCash", "NatCash"], "HU": ["Barion", "SimplePay", "qvik"], "ID": ["Cards"], "IT": ["Bancomat Pay", "Satispay"], "JM": ["Bank Transfer", "Cards", "Lynk", "Online Banking", "WiPay"], "JO": ["Cards"], "KE": ["AIRTEL_MONEY", "APPLE_PAY", "MPESA", "PESALINK", "PESAPAL", "T_KASH", "Cards"], "KI": ["Bank Transfer", "Cards", "Mobile Banking"], "KN": ["Bank Transfer", "Cards", "Online Banking"], "KW": ["Cards"], "LC": ["Bank Transfer", "Cards", "Online Banking", "WiPay"], "LK": ["qr"], "LR": ["Liberia"], "LY": ["Libya"], "MA": ["Morocco"], "MH": ["Bank Transfer", "Cards", "Mobile/Internet Banking"], "MN": ["Cards"], "MX": ["Cards", "CoDi", "DiMo", "Mercado Pago", "OXXO Pay", "SPEI"], "MY": ["Cards"], "NA": ["Namibia"], "NE": ["Niger"], "NG": ["Cards"], "NI": ["Bank Mobile Banking", "Bank Transfer", "Cards"], "NL": ["iDEAL / Wero"], "NO": ["Vipps"], "NR": ["Bank Transfer", "Cards"], "NZ": ["Account-to-Account Bank Transfer", "Apple Pay/Google Pay", "POLi", "Visa/Mastercard", "Windcave", "Cards", "eftpos"], "PA": ["ACH", "Bank Transfer", "Cards", "Nequi", "Yappy"], "PE": ["BIM", "Bank Transfer", "Lukita", "Mastercard", "PagoEfectivo", "Plin", "Tunki", "Visa", "Yape"], "PG": ["BSP Mobile Banking", "Bank Transfer", "Cards", "Digicel MyCash", "EFTPOS", "Kina Bank Mobile Banking", "MiBank Mobile Banking"], "PL": ["BLIK", "Przelewy24"], "PT": ["MB WAY", "Multibanco"], "PW": ["Bank Transfer", "Cards", "Mobile/Internet Banking"], "PY": ["Aquí Pago", "Bancard QR", "Bank Transfer", "Cards", "Pago Móvil", "Personal Pay", "Practipago", "Tigo Money", "Zimple"], "RO": ["RoPay"], "RS": ["IPS"], "RW": ["Cards"], "SA": ["Cards"], "SB": ["ANZ goMoney", "BRED Mobile Banking", "BSP Mobile Banking", "Bank Transfer", "Cards", "M-Selen"], "SE": ["Swish"], "SI": ["Flik"], "SK": ["TatraPay"], "SL": ["Sierra Leone"], "SR": ["Bank Transfer", "Cards", "Telesur Mobile Money", "Uni5Pay+"], "ST": ["São Tomé and Príncipe"], "SV": ["Bank Transfer", "Cards", "Chivo", "Mobile Banking"], "TL": ["Bank Transfer", "Mobile Banking", "Visa/Mastercard"], "TO": ["ANZ Mobile Banking", "BSP Mobile Banking", "Bank Transfer", "Cards", "Digicel MyCash"], "TR": ["FAST", "Papara"], "TT": ["Bank Transfer", "Cards", "Online Banking", "SurePay", "WiPay"], "TV": ["Bank Transfer", "Cards"], "TZ": ["Cards"], "UA": ["LiqPay"], "UG": ["Cards"], "US": ["ACH", "Apple Pay/Google Pay", "Cash App", "Debit/Credit Cards", "FedNow", "PayPal", "RTP", "Venmo", "Zelle", "Cards"], "UY": ["Abitab", "BANRED", "Bank Transfer", "Cards", "Mercado Pago", "Paganza", "Redpagos"], "VC": ["Bank Transfer", "Cards", "Online Banking", "WiPay"], "VE": ["Bank Transfer", "Cards", "Pago Móvil Interbancario", "PagoClave"], "VU": ["ANZ Mobile Banking", "BRED Mobile Banking", "Bank Transfer", "Cards", "Digicel Mobile Money", "M-VATU"], "WS": ["ANZ Mobile Banking", "BSP Mobile Banking", "Bank Transfer", "Cards", "Digicel MyCash"], "ZA": ["Cards"], "ZW": ["Cards"]};
