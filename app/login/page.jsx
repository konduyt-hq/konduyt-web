...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!r.ok) throw new Error(d.error?.message || d.detail || 'Login failed')
    ...
    <div style={{ minHeight:'100vh', background:'#07090F', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'Inter,sans-serif', padding:'20px' }}>
      <div style={{ width:'100%', maxWidth:'380px' }}>
        <div style={{ textAlign:'center', marginBottom:'32px' }}>
          ...
          <div style={{ fontSize:'14px', color:'rgba(237,240,247,0.5)' }}>Sign in to your account</div>
        </div>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'16px' }}>
        ...
        <div style={{ flex:1, height:'1px', background:'rgba(255,255,255,0.08)' }} />
          ...
          <div style={{ textAlign:'center', marginTop:'16px', fontSize:'13px', color:'rgba(237,240,247,0.4)' }}>
            No account? <Link href="/signup" style={{color:'#FF5C35', textDecoration:'none', fontWeight:600}}>Sign up free</Link>
          </div>
        </div>
      </div>
    </div>
